...
struct bgp_linkstate_tlv_info bgp_linkstate_tlv_infos[BGP_LS_TLV_MAX] = {
	/* NLRI TLV */
	[BGP_LS_TLV_LOCAL_NODE_DESCRIPTORS] = {"Local Node Descriptors", 1,
					       MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_REMOTE_NODE_DESCRIPTORS] = {"Remote Node Descriptors", 1,
						MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_LINK_LOCAL_REMOTE_IDENTIFIERS] =
		{"Link Local/Remote Identifiers", 2, 2, UNDEF_MULTPL},
	[BGP_LS_TLV_IPV4_INTERFACE_ADDRESS] = {"IPv4 interface address", 4, 4,
					       UNDEF_MULTPL},
	[BGP_LS_TLV_IPV4_NEIGHBOR_ADDRESS] = {"IPv4 neighbor address", 4, 4,
					      UNDEF_MULTPL},
	[BGP_LS_TLV_IPV6_INTERFACE_ADDRESS] = {"IPv6 interface address", 16, 16,
					       UNDEF_MULTPL},
	[BGP_LS_TLV_IPV6_NEIGHBOR_ADDRESS] = {"IPv6 neighbor address", 16, 16,
					      UNDEF_MULTPL},
	...
	[BGP_LS_TLV_AUTONOMOUS_SYSTEM] = {"Autonomous System", 4, 4,
					  UNDEF_MULTPL},
	[BGP_LS_TLV_BGP_LS_IDENTIFIER] = {"BGP-LS Identifier", 4, 4,
					  UNDEF_MULTPL},
	...
	[BGP_LS_TLV_BGP_CONFEDERATION_MEMBER] = {"BGP Confederation Member", 4,
						 4, UNDEF_MULTPL},
	[BGP_LS_TLV_NODE_FLAG_BITS] = {"Node Flag Bits", 1, 1, UNDEF_MULTPL},
	[BGP_LS_TLV_OPAQUE_NODE_ATTRIBUTE] = {"Opaque Node Attribute", 1,
					      MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_NODE_NAME] = {"Node Name", 1, MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_IS_IS_AREA_IDENTIFIER] = {"IS-IS Area Identifier", 1, 13,
					      UNDEF_MULTPL},
	...
	[BGP_LS_TLV_S_BFD_DISCRIMINATORS] = {"S-BFD Discriminators", 4, MAX_SZ,
					     4},
	[BGP_LS_TLV_SR_CAPABILITIES] = {"SR Capabilities", 12, MAX_SZ,
					UNDEF_MULTPL},
	[BGP_LS_TLV_SR_ALGORITHM] = {"SR Algorithm", 1, MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_SR_LOCAL_BLOCK] = {"SR Local Block", 12, MAX_SZ,
				       UNDEF_MULTPL},
	...
	[BGP_LS_TLV_ADMINISTRATIVE_GROUP] = {"Administrative group", 4, 4,
					     UNDEF_MULTPL},
	[BGP_LS_TLV_MAXIMUM_LINK_BANDWIDTH] = {"Maximum link bandwidth", 4, 4,
					       UNDEF_MULTPL},
	[BGP_LS_TLV_MAX_RESERVABLE_LINK_BANDWIDTH] =
		{"Max. reservable link bandwidth", 4, 4, UNDEF_MULTPL},
	[BGP_LS_TLV_UNRESERVED_BANDWIDTH] = {"Unreserved bandwidth", 32, 32,
					     UNDEF_MULTPL},
	[BGP_LS_TLV_TE_DEFAULT_METRIC] = {"TE Default Metric", 3, 4,
					  UNDEF_MULTPL},
	[BGP_LS_TLV_LINK_PROTECTION_TYPE] = {"Link Protection Type", 2, 2,
					     UNDEF_MULTPL},
	[BGP_LS_TLV_MPLS_PROTOCOL_MASK] = {"MPLS Protocol Mask", 1, 1,
					   UNDEF_MULTPL},
	[BGP_LS_TLV_IGP_METRIC] = {"IGP Metric", 1, 3, UNDEF_MULTPL},
	[BGP_LS_TLV_SHARED_RISK_LINK_GROUP] = {"Shared Risk Link Group", 4,
					       MAX_SZ, 4},
	[BGP_LS_TLV_OPAQUE_LINK_ATTRIBUTE] = {"Opaque Link Attribute", 1,
					      MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_LINK_NAME] = {"Link Name", 1, MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_ADJACENCY_SID] = {"Adjacency SID", 7, 8, UNDEF_MULTPL},
	[BGP_LS_TLV_LAN_ADJACENCY_SID] = {"LAN Adjacency SID", 11, 14,
					  UNDEF_MULTPL},
	...
	[BGP_LS_TLV_RTM_CAPABILITY] = {"RTM Capability", 1, MAX_SZ,
				       UNDEF_MULTPL},
	[BGP_LS_TLV_UNIDIRECTIONAL_LINK_DELAY] = {"Unidirectional Link Delay",
						  4, 4, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_UNIDIRECTIONAL_LINK_LOSS] = {"Unidirectional Link Loss", 4,
						 4, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_GRACEFUL_LINK_SHUTDOWN_TLV] = {"Graceful-Link-Shutdown TLV",
						   0, 0, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_IGP_EXTENDED_ROUTE_TAG] = {"IGP Extended Route Tag", 8,
					       MAX_SZ, 8},
	[BGP_LS_TLV_PREFIX_METRIC] = {"Prefix Metric", 3, 4, UNDEF_MULTPL},
	[BGP_LS_TLV_OSPF_FORWARDING_ADDRESS] = {"OSPF Forwarding Address", 4, 4,
						UNDEF_MULTPL},
	[BGP_LS_TLV_OPAQUE_PREFIX_ATTRIBUTE] = {"Opaque Prefix Attribute", 1,
						MAX_SZ, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_PREFIX_ATTRIBUTES_FLAGS] = {"Prefix Attributes Flags", 1,
						MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_SOURCE_ROUTER_IDENTIFIER] = {"Source Router Identifier", 4,
						 16, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_SOURCE_OSPF_ROUTER_ID] = {"Source OSPF Router-ID", 4, 4,
					      UNDEF_MULTPL},
	/* display not yet supported */
	[BGP_LS_TLV_SRV6_SID_INFORMATION_TLV] = {"SRv6 SID Information TLV",
						 UNDEF_MIN_SZ, MAX_SZ,
						 UNDEF_MULTPL},
	[BGP_LS_TLV_TUNNEL_ID_TLV] = {"Tunnel ID TLV", UNDEF_MIN_SZ, MAX_SZ,
				      UNDEF_MULTPL},
	[BGP_LS_TLV_LSP_ID_TLV] = {"LSP ID TLV", UNDEF_MIN_SZ, MAX_SZ,
				   UNDEF_MULTPL},
	...
	[BGP_LS_TLV_MPLS_CROSS_CONNECT_INTERFACE_TLV] =
		{"MPLS Cross Connect Interface TLV", UNDEF_MIN_SZ, MAX_SZ,
		 UNDEF_MULTPL},
	[BGP_LS_TLV_MPLS_CROSS_CONNECT_FEC_TLV] = {"MPLS Cross Connect FEC TLV",
						   UNDEF_MIN_SZ, MAX_SZ,
						   UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_CAPABILITIES_TLV] = {"SRv6 Capabilities TLV",
					      UNDEF_MIN_SZ, MAX_SZ,
					      UNDEF_MULTPL},
	[BGP_LS_TLV_FLEXIBLE_ALGORITHM_UNSUPPORTED] =
		{"Flexible Algorithm Unsupported", UNDEF_MIN_SZ, MAX_SZ,
		 UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_END_X_SID_TLV] = {"SRv6 End.X SID TLV", UNDEF_MIN_SZ,
					   MAX_SZ, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_OSPFV3_SRV6_LAN_END_X_SID_TLV] =
		{"OSPFv3 SRv6 LAN End.X SID TLV", UNDEF_MIN_SZ, MAX_SZ,
		 UNDEF_MULTPL},
	[BGP_LS_TLV_IS_IS_FLOOD_REFLECTION] = {"IS-IS Flood Reflection",
					       UNDEF_MIN_SZ, MAX_SZ,
					       UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_LOCATOR_TLV] = {"SRv6 Locator TLV", UNDEF_MIN_SZ,
					 MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_MPLS_TE_POLICY_STATE_TLV] = {"MPLS-TE Policy State TLV",
						 UNDEF_MIN_SZ, MAX_SZ,
						 UNDEF_MULTPL},
	[BGP_LS_TLV_SR_BSID_TLV] = {"SR BSID TLV", UNDEF_MIN_SZ, MAX_SZ,
				    UNDEF_MULTPL},
	[BGP_LS_TLV_SR_CP_STATE_TLV] = {"SR CP State TLV", UNDEF_MIN_SZ, MAX_SZ,
					UNDEF_MULTPL},
	[BGP_LS_TLV_SR_CP_NAME_TLV] = {"SR CP Name TLV", UNDEF_MIN_SZ, MAX_SZ,
				       UNDEF_MULTPL},
	[BGP_LS_TLV_SR_CP_CONSTRAINTS_TLV] = {"SR CP Constraints TLV",
					      UNDEF_MIN_SZ, MAX_SZ,
					      UNDEF_MULTPL},
	[BGP_LS_TLV_SR_SEGMENT_LIST_TLV] = {"SR Segment List TLV", UNDEF_MIN_SZ,
					    MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_SR_SEGMENT_SUB_TLV] = {"SR Segment sub-TLV", UNDEF_MIN_SZ,
					   MAX_SZ, UNDEF_MULTPL},
	...
	[BGP_LS_TLV_SR_AFFINITY_CONSTRAINT_SUB_TLV] =
		{"SR Affinity Constraint sub-TLV", UNDEF_MIN_SZ, MAX_SZ,
		 UNDEF_MULTPL},
	[BGP_LS_TLV_SR_SRLG_CONSTRAINT_SUB_TLV] = {"SR SRLG Constraint sub-TLV",
						   UNDEF_MIN_SZ, MAX_SZ,
						   UNDEF_MULTPL},
	...
	[BGP_LS_TLV_SR_DISJOINT_GROUP_CONSTRAINT_SUB_TLV] =
		{"SR Disjoint Group Constraint sub-TLV", UNDEF_MIN_SZ, MAX_SZ,
		 UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_BSID_TLV] = {"SRv6 BSID TLV", UNDEF_MIN_SZ, MAX_SZ,
				      UNDEF_MULTPL},
	[BGP_LS_TLV_SR_POLICY_NAME_TLV] = {"SR Policy Name TLV", UNDEF_MIN_SZ,
					   MAX_SZ, UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_ENDPOINT_FUNCTION_TLV] = {"SRv6 Endpoint Function TLV",
						   UNDEF_MIN_SZ, MAX_SZ,
						   UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_BGP_PEER_NODE_SID_TLV] = {"SRv6 BGP Peer Node SID TLV",
						   UNDEF_MIN_SZ, MAX_SZ,
						   UNDEF_MULTPL},
	[BGP_LS_TLV_SRV6_SID_STRUCTURE_TLV] = {"SRv6 SID Structure TLV",
					       UNDEF_MIN_SZ, MAX_SZ,
					       UNDEF_MULTPL},
};
	...
	uint16_t len)
{
	...
	while (pnt < lim) {
		...
		if (bgp_ls_tlv_check_size(type, length) == false)
	...
	bool multiline)
{
	...
	if (CHECK_FLAG(node_descr->flags,
		...
		case BGP_LS_TLV_IGP_ROUTER_ID_ISIS_NON_PSEUDOWIRE_SIZE:
		case BGP_LS_TLV_IGP_ROUTER_ID_ISIS_PSEUDOWIRE_SIZE:
			snprintf(buf, size, "%sRtr:%s", first ? "" : " ",
				 lib_isis_format_id(
						     ...
						     json_object *json)
{
	if (length == 4) {
		if (json) {
			json_object_string_addf(json, "data", "%pI4", pnt);
			return;
		}
		vty_out(vty, "%pI4\n", pnt);
	} else if (length == 16) {
		if (json) {
			json_object_string_addf(json, "data", "%pI6", pnt);
			return;
		}
		vty_out(vty, "%pI6\n", pnt);
	} else
		...
		if (length == 11 || length == 12) {
			...
			if (json)
				json_object_string_addf(
					json_data, "neighborId", "%s\n",
					lib_isis_format_id(pnt, 6));
			else
				vty_out(vty, "%s\n",
					lib_isis_format_id(pnt, 6));
			pnt += 6;
							    ...
							    json_object *json)
{
	...
	if (json)
		json_object_string_add(json, "data",
				       lib_isonet_print(pnt, length));
	else
		vty_out(vty, "%s\n", lib_isonet_print(pnt, length));
}
...
bgp_linkstate_tlv_attribute_value_display(struct vty *vty, uint8_t *pnt,
					  ...
					  int indent, json_object *json)
{
	if (bgp_ls_tlv_check_size(code_point, psize) == false) {
