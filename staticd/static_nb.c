...
const struct frr_yang_module_info frr_staticd_info = {
	...
	.nodes = {
		...
		{
			.xpath = "/frr-routing:routing/control-plane-protocols/control-plane-protocol/frr-staticd:staticd/route-list/path-list/frr-nexthops/nexthop/bfd-monitoring/hop-type",
			.cbs = {
				.modify = route_next_hop_bfd_hop_type_modify,
				.destroy = route_next_hop_bfd_hop_type_destroy,
			}
		},
		{
