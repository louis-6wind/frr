...
.. clicmd:: debug bgp updates prefix <A.B.C.D/M|X:X::X:X/M|ASN:rt:EF:OPQR/M|ASN:rt:GHJK:MN/M|ASN:rt:A.B.C.D:MN/M>
...
.. clicmd:: debug bgp bestpath <A.B.C.D/M|X:X::X:X/M|ASN:rt:EF:OPQR/M|ASN:rt:GHJK:MN/M|ASN:rt:A.B.C.D:MN/M>
...
.. clicmd:: show [ip] bgp [afi] [safi] [all] neighbors A.B.C.D [advertised-routes|received-routes|filtered-routes] [<A.B.C.D/M|X:X::X:X/M|ASN:rt:EF:OPQR/M|ASN:rt:GHJK:MN/M|ASN:rt:A.B.C.D:MN/M> | detail] [json|wide]
...
.. clicmd:: network [ASN:rt:]<EF:OPQR|GHJK:MN|A.B.C.D:MN>[/M]
   ...
   If the AS number is unspecified, the local AS number is implictly set.
